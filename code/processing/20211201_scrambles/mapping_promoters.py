...
datadir = f"{homedir}/data/seq/processed_sequencing/20211201_grouped_mapping/"

# List all fastq.gz files
fastq_file = datadir + "scrambles_merged.fastq.gz"
...
# Define output dir
outputdir = f"{homedir}/data/seq/barcodes/20211201_grouped_mapping"
