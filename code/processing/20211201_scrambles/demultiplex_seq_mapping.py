...
INPUT_DIR = f'{homedir}/data/seq/raw_sequencing/{DATE}{DESCRIPTION}' 

# Path containing raw input sequences
RAW_DIR = INPUT_DIR + '211201_M05340_0297_000000000-K579J/Data/Intensities/BaseCalls/'
...
OUTPUT_DIR = f'{homedir}/data/seq/demux_sequencing/' +\
             f'{DATE}{DESCRIPTION}'
